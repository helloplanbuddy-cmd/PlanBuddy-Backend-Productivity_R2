...
/**
 * webhook-events — event-driven webhook processing
 * 🚀 PHASE 3: Critical for payment confirmation reliability
 * - 5 attempts with exponential backoff
 * - Idempotent job IDs based on webhook event ID
...
const webhookQueue = new Queue('webhook-events', {
  ...
  defaultJobOptions: {
    ...
    attempts: 5,
    backoff:  { type: 'exponential', delay: 1_000 },
    removeOnComplete: { age: 3600, count: 100 },  // Keep 1h
    removeOnFail:     { age: 86400, count: 500 },  // Keep 24h
  },
});
